    ...
    <div className="min-h-screen bg-slate-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-slate-900 mb-4">{t('articles.title')}</h1>
          <p className="text-xl text-slate-500 max-w-2xl mx-auto">{t('articles.subtitle')}</p>
        </div>

        {articles.length === 0 ? (
          <div className="text-center py-20 text-slate-500 italic">{t('articles.noArticles')}</div>
        ) : (
